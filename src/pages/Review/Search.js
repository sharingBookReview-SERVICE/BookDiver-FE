...
const Search = props => {
  ...
  useEffect(() => {
    ...
    return dispatch(searchActions.resetSelectedBook())
  }, [dispatch])
                ...
                >
                  <Img
                    ...
                    src={
                      p.image
                        ? p.image
                        : "https://i.pinimg.com/564x/93/1f/39/931f390f4037e44ee162d9d4f4cd6663.jpg"
                    }
                  ></Img>
                  <FigTitle>
                    {
