...
const BookDetail = props => {
  ...
  const reviews_which_book_have = useSelector(
    state => state.review.reviews_which_book_have
  )
    ...
    <React.Fragment>
      <Main>
        ...
        <Container>
          ...
          <BookIntro>책소개</BookIntro>
          <BookContents>{book.description}</BookContents>
        </Container>

        <BookReview>게시물({review_count}개)</BookReview>
