...
const EditCollection = props => {
  ...
  const editCollection = () => {
    ...
    dispatch(
      collectionActions.editCollectionDetailSV(collection_id, collection)
    )
  }
  ...
  return (
    <Container>
      ...
      <Wrapper>
        <Label>컬렉션 제목</Label>
        <TitleInput ref={_name}></TitleInput>
        ...
        <Label>컬렉션 설명</Label>
        <DescTextarea ref={_description}></DescTextarea>

        {selected_Books?.map(book => {
          return (
            <CollectionBookCard is_edit_collection {...book} key={book.isbn} />
          )
        })}
        {more_select && <AddBook />}
        <MoreAddbtn
