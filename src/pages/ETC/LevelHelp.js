    ...
    return(
        <Container>
            ...
            </SliderContainer>
            {
                currentSlide === 0 &&
                <div>
                   <HowToBtn onClick={nextSlide}>어떻게 쓸 수 있나요?<ArrowForwardIcon/></HowToBtn>
                   <SkipBtn onClick={()=>{goToMyDepth()}}>건너띄고 바로 내 상태 확인하기<ArrowForwardIcon/></SkipBtn>
                  </div>
          ...
          
            {
                ...
                <PrevBtn onClick={prevSlide}> <ArrowBackIcon/> 이전</PrevBtn>
                </div>
            ...
            }
              {
                ...
                <FinishBtn onClick={()=>{goToMyDepth()}}>내 잠수상태 확인하기<ArrowForwardIcon/></FinishBtn>
